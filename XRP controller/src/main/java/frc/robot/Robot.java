...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    // PS5Controller ps5Controller = new PS5Controller(0);
    ps5 = new Joystick(0);
  ...
  public static double roundToZero(double value, double threshold){
  ...
  public void teleopPeriodic() {
    double forwardSpeed = -ps5.getRawAxis(1);
    double rotationSpeed = ps5.getRawAxis(4);

    rotationSpeed = roundToZero(rotationSpeed, 0.1);
    forwardSpeed = roundToZero(forwardSpeed, 0.05);

    // Calculate left and right motor speeds
    double leftMotorSpeed = forwardSpeed + rotationSpeed;
    double rightMotorSpeed = forwardSpeed - rotationSpeed;
